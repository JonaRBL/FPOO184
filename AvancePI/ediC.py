...
class ediC():
    ...
    def __init__(self):
        self.edifC = Tk()
        self.edifC.title("Edificio C")
        self.edifC.geometry("600x400")

        #2.Agregamos los Frames
        self.seccion1 = Frame(self.edifC, bg = "red")
        self.seccion1.pack(expand = True, fill = 'both')

        self.titulo = Label (self.seccion1, text = "Edificio C", bg = "White" ,width=50)
        ...
        img = Image.open("C:\\Users\\jonat\\OneDrive\\Documentos\\UPQ\\5to cuatri\\UPQ Fundamentos de Programación Orientada a Objetos\\TRABAJOS\\P2\\FPOO184\\AvancePI\\edificioC.jpg")
        ...
        self.edifC.config(menu=self.menubar)
        self.file_menu = Menu(self.menubar, tearoff=False)
        self.file_menu.add_command( label="Edificio A")
        self.file_menu.add_command( label="Edificio B")
        ...
        self.file_menu.add_command( label="LT1")
