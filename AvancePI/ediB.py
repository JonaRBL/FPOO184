...
class ediB():
    def __init__(self):
        ...
        self.edifB = Tk()
        self.edifB.title("Edificio B")
        self.edifB.geometry("600x400")

        #2.Agregamos los Frames
        self.seccion1 = Frame(self.edifB, bg = "red")
        self.seccion1.pack(expand = True, fill = 'both')

        self.titulo = Label (self.seccion1, text = "Edificio B", bg = "White" ,width=50)
        ...
        img = Image.open("C:\\Users\\jonat\\OneDrive\\Documentos\\UPQ\\5to cuatri\\UPQ Fundamentos de Programación Orientada a Objetos\\TRABAJOS\\P2\\FPOO184\\AvancePI\\edificioB.jpg")
        ...
        self.edifB.config(menu=self.menubar)
