...
edifB = Tk()
edifB.title("Edificio B")
edifB.geometry("600x400")

#2.Agregamos los Frames
seccion1 = Frame(edifB, bg = "red")
seccion1.pack(expand = True, fill = 'both')

titulo = Label (seccion1, text = "Edificio B", bg = "White" ,width=50)
